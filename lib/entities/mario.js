...
export default class Mario extends Entity {
    constructor(img, xPos, yPos, width, height) {
        ...
        this.spriteAnimations = {
            walkRight: {
                frames: [
                    new Sprite(img, 45, 0, 30, 50),
                    new Sprite(img, 95, 0, 30, 50),
                    new Sprite(img, 135, 0, 30, 50),
                ],
                currentFrame: 0,
            },
            walkLeft: {
                frames: [
                    new Sprite(img, 832, 55, 30, 50),
                    new Sprite(img, 795, 55, 30, 50),
                    new Sprite(img, 755, 55, 30, 50),
                ],
                currentFrame: 0,
            },
            ...
            standRight: new Sprite(img, 0, 0, 30, 50),
            standLeft: new Sprite(img, 875, 55, 30, 50),
            jumpRight: new Sprite(img, 225, 0, 30, 50),
            jumpLeft: new Sprite(img, 655, 55, 30, 50),

            bigStandRight: new Sprite(img, 0, 0, 30, 50),
            bigStandLeft: new Sprite(img, 875, 55, 30, 50),
            bigJumpRight: new Sprite(img, 225, 0, 30, 50),
            bigJumpLeft: new Sprite(img, 655, 55, 30, 50),
            dead: new Sprite(img, 275, 0, 30, 50),
        };
