...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return Princess; });
...
class Princess extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
    constructor(img, xPos, yPos, width, height) {
        // For SVG, use a large source area to capture the full character
        // The entity width/height will scale it to the desired size
        const sprite = new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 200, 200);
        super('princess', sprite, xPos, yPos, width, height);
    }
}
...
class Goomba extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  constructor(img, xPos, yPos, width, height) {
    const sprite = new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 100, 100);
    ...
    this.spriteAnimations = {
      walking: {
        frames: [
          new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 100, 100),
          new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 100, 100),
        ],
        currentFrame: 0,
      },
      dead: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 100, 100),
    };
...
class Koopa extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
    constructor(img, xPos, yPos, width, height) {
        ...
        this.spriteAnimations = {
            ...
            hiding: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 100, 100),
        };
...
class Mario extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
    constructor(img, xPos, yPos, width, height) {
        ...
        this.spriteAnimations = {
            walkRight: {
                frames: [
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 45, 0, 30, 50),
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 95, 0, 30, 50),
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 135, 0, 30, 50),
                ],
                currentFrame: 0,
            },
            walkLeft: {
                frames: [
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 832, 55, 30, 50),
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 795, 55, 30, 50),
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 755, 55, 30, 50),
                ],
                currentFrame: 0,
            },
            // standRight: new Sprite(img, 45, 0, 30, 50),
            bigWalkRight: {
                frames: [
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 45, 0, 30, 50),
                    new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 95, 0, 30, 50),
            ...
            standRight: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 30, 50),
            standLeft: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 875, 55, 30, 50),
            jumpRight: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 225, 0, 30, 50),
            jumpLeft: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 655, 55, 30, 50),

            bigStandRight: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 30, 50),
            bigStandLeft: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 875, 55, 30, 50),
            bigJumpRight: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 225, 0, 30, 50),
            bigJumpLeft: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 655, 55, 30, 50),
            dead: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 275, 0, 30, 50),
        };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__entities_scenery__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__entities_block__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__entities_breakable__ = __webpack_require__(15);
...
class MapBuilder {
  constructor(level, tileset, spriteSheet) {
    ...
    this.princessSheet = new Image();
    this.princessSheet.src = './assets/sprites/Princess.svg';
    
    this.sceneryEntities.push(
      new __WEBPACK_IMPORTED_MODULE_0__entities_scenery__["l" /* Princess */](
        this.princessSheet, level.princess[0], level.princess[1], level.princess[2], level.princess[3]),
    );
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mushroom__ = __webpack_require__(17);
...
class Block extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  ...
  createMushroom(data) {
    const mushroom = new __WEBPACK_IMPORTED_MODULE_3__mushroom__["a" /* default */]('./assets/sprites/marlboro.png', this.xPos, this.yPos - 18, 16, 16);
...
class Mushroom extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  constructor(img, xPos, yPos, width, height) {
    const sprite = new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 137, 207);
    super('mushroom', sprite, xPos, yPos, width, height);

    const self = this;

    this.spriteAnimations = {
      moving: new __WEBPACK_IMPORTED_MODULE_1__sprite__["a" /* default */](img, 0, 0, 137, 207),
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__map_level_1_1__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__map_map_builder__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__entities_mario__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__entities_goomba__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__entities_koopa__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__entities_score__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__entities_scenery__ = __webpack_require__(2);
...
class Game {
  ...
  init() {
    ...
    spriteSheet.addEventListener('load', () => {
      ...
      const mario = new __WEBPACK_IMPORTED_MODULE_7__entities_mario__["a" /* default */](marioSprite, 175, 0, 30, 40);
      ...
      __WEBPACK_IMPORTED_MODULE_5__map_level_1_1__["a" /* levelOne */].koopas.forEach((koopa) => {
        data.entities.koopas.push(
          new __WEBPACK_IMPORTED_MODULE_9__entities_koopa__["a" /* default */](radarImage, koopa[0], koopa[1], koopa[2], koopa[3]));
      });

      __WEBPACK_IMPORTED_MODULE_5__map_level_1_1__["a" /* levelOne */].goombas.forEach((goomba) => {
        data.entities.goombas.push(
          new __WEBPACK_IMPORTED_MODULE_8__entities_goomba__["a" /* default */](radarImage, goomba[0], goomba[1], goomba[2], goomba[3]));
      });
